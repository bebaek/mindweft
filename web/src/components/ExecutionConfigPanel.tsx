...
function ExecutionConfigEditor({ current, mcpCatalog, mcpCatalogPending, mcpCatalogError, pending, validation, error, onClose, onApply }: { current: Record<string, unknown> | null; mcpCatalog: AdminMcpServerCatalogItem[]; mcpCatalogPending: boolean; mcpCatalogError: string | null; pending: boolean; validation: AdminExecutionValidation | null; error: string | null; onClose: () => void; onApply: (config: Record<string, unknown>) => void }) {
