...
from mindweft_config.agent_skills import discover_agent_skills
from mindweft_config.schema import parse_unified_config
...
_SIMPLE_SECTION_ENV_MAP: dict[str, dict[str, str]] = {
    ...
    "document_input": {
        ...
        "max_text_bytes": "MINIGENT_DOCUMENT_INPUT_MAX_TEXT_BYTES",
