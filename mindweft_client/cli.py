...
from mindweft_client.backends.stdin_loop import StdinActivationSource
from mindweft_client.chat_commands import _format_markdown_transcript
...
from mindweft_client.ring_buffer import AudioRingBuffer
from mindweft_client.runtime import ActivationSource, MindweftClientRuntime
from mindweft_client.speech import (
    ConsoleSpeechOutput,
    MacOsSaySpeechOutput,
    PiperSpeechOutput,
    SilentSpeechOutput,
)
from mindweft_client.state import (
...
from mindweft_client.vad import SileroVoiceActivityDetector
from mindweft_client.wakeword import OpenWakeWordDetector, PorcupineWakeWordDetector
...
def main(argv: list[str] | None = None) -> int:
    ...
    if one_shot_command is not None:
        from mindweft_client.one_shot_cli import main as one_shot_main
