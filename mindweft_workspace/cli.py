...
from mindweft_config.unified_config import DEFAULT_CODING_DOTENV_FILE, preferred_mindweft_env
...
def run_config_command(argv: list[str]) -> int:
    ...
    if args.command == "config" and args.config_command == "export":
        ...
        from mindweft_client.one_shot_cli import main as client_main
