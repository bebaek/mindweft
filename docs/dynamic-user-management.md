...
identity-provider mapping, service-account modeling, seat/billing limits, personal MCP/credential
runtime integration, and dedicated console editors for the partially implemented user-owned
execution overlay.
