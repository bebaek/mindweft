...
def export_local_coding_config(args: Namespace) -> dict[str, object]:
    ...
    shell_bridge_name = (
        env.get("MINIGENT_CODING_SHELL_BRIDGE_NAME") or runner.DEFAULT_SHELL_BRIDGE_NAME
    )
    shell_bridge_port = int(
        env.get("MINIGENT_CODING_SHELL_BRIDGE_PORT") or runner.DEFAULT_SHELL_BRIDGE_PORT
    )
